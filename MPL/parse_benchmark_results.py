...
raw_file_path = 'sum_squares_benchmark_results_raw.csv'
processed_file_path = 'sum_squares_benchmark_results_processed.csv'

pattern = re.compile(r"Sum squares (.*) (\d+)")
...
with open(raw_file_path, 'r', newline='') as raw_file:
    ...
    for row in raw_reader:
        ...
        (category, size) = pattern.match(name).groups()
