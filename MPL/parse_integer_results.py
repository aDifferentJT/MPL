...
raw_file_path = 'sum_integers_benchmark_results_raw.csv'
processed_file_path = 'sum_integers_benchmark_results_processed.csv'

pattern = re.compile(r"Sum squares integer (.*) (\d+)_mean")
